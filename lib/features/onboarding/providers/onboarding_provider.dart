...
//             'referral_code': code,
//             'points_total': 0,
//             // tier_id left null on purpose — see note below
//           });
//           return true; // success
//         } on PostgrestException catch (e) {
//           // 23505 = unique_violation. Retry with a new code.
...
//   /// Checks the DB for an existing referral_code before returning a candidate.
//   /// Doesn't fully eliminate race conditions (two signups in the same
//   /// millisecond), which is why the insert above also catches 23505.
//   Future<String> _generateUniqueReferralCode(String name) async {
//     for (var i = 0; i < 5; i++) {
//       final candidate = _buildCandidateCode(name);
//       final existing = await _supabase
