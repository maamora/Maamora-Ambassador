      ...
      children: [
        Expanded(
          child: _SocialButton(
            ...
            onPressed: () {
              // TODO: wire google_sign_in package
            },
          ),
        ),
        ...
        Expanded(
          child: _SocialButton(
            ...
            icon: Icons.apple,
            onPressed: () {
              // TODO: wire sign_in_with_apple package
            },
          ),
        ),
      ],
...
class _SocialButton extends StatelessWidget {
  ...
  //   // login_screen.dart — corrected methods only, rest of the file is unchanged
  ...
  //       widget.onLoginSuccess?.call();
  //     }
  //     // On failure, provider.errorMessage is already set and rendered
  //     // by _buildErrorBanner via the Consumer — nothing else to do here.
  //   }
