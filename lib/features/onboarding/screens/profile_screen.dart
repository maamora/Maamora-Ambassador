...
//             fontSize: 24,
//             fontWeight: FontWeight.bold,
//             color: Color(0xFF1A2433), // AppColors.onSurface
//           ),
//         ),
//       ),
...
//             const SizedBox(
//               height: 24,
//             ), // Extra padding for bottom nav if needed
//           ],
//         ),
//       ),
//     );
...
//                   image: NetworkImage(
//                     'https://lh3.googleusercontent.com/aida-public/AB6AXuCXsMcBHWFOGlocF-LmH3GYJLf2XvbIANvFOWaKHIb5PS-GmTfy8wOAWXRPeAk9weOhwRdhNQ59mG-IQ4-regDo--H2fZRcq_TC4JIgN6jhgQpxCLV1KBN5uM-P4PFMxEi_heEP6Zi5wADoSGWMWDVSAMrZunb4k7qrzcq3O4kg6y4xngBdv1AgngZL6EvSxmrGjt-rALc2HvBmqAbKhTrUAvD0T5mGmCoatZoDG7famvyafC66fj8Mrg',
//                   ),
//                   fit: BoxFit.cover,
//                 ),
//               ),
...
//                 padding: const EdgeInsets.all(8),
//                 decoration: const BoxDecoration(
//                   color: Color(0xFFFB7701), // AppColors.primary
//                   shape: BoxShape.circle,
//                   boxShadow: [BoxShadow(color: Colors.black12, blurRadius: 4)],
//                 ),
//                 child: const Icon(
...
//           ),
//           const SizedBox(height: 8),
//           _AccountDetailRow(label: 'Nom complet', value: 'Sarah Jenkins'),
//           const Divider(height: 1, color: Color(0xFFF3F4F6)), // Gray 100
//           _AccountDetailRow(label: 'Code de parrainage', value: 'SARA4829'),
//           const Divider(height: 1, color: Color(0xFFF3F4F6)),
//           _AccountDetailRow(
//             label: 'Adresse Email',
